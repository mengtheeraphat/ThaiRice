...
<!-- ---------------------------ค้นหาพันธุ์ข้าว--------------------------------- -->
<form id='save_area' name='save_area' action='update_status_f1_process.jsp' method="get">
<center>
<div class="container">
  <div>
    <h2 id="scrollspyHeading1">บันทึกเวลาการใส่ปุ๋ยครั้งที่ 1</h2>
  </div>
</div>
</center>
<br>
...
<div class="form-group row">
  ...
  <!--------------------------------     <div class="row gx-3 gy-2 align-items-center">        ----------------------------------------->
       ...
       <div class="form-group row">
        <label for="colFormLabel" class="col-sm-4 col-lg-2 col-form-label">วันที่ใส่ปุ๋ยครั้งที่ 1</label>
        <div class="col-sm-4">
              <input type="date" id="fertilizer1_date_real" name="fertilizer1_date_real">
        </div>
      </div>  
        <input type="hidden" name="fertilizer1_status" id="fertilizer1_status" value="Y">
      <!--------------------------------      </div>        ----------------------------------------->
</div>
</div>
