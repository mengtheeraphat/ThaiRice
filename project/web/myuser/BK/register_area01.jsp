...
<div class="form-group row">
  ...
  <div class="form-group row">
    <label for="colFormLabel" class="col-sm-3 col-form-label">จังหวัดที่เพาะปลูก</label>
        ...
        <input type="hidden" name="fertilizer1_status" id="fertilizer1_status" value="C">
        <input type="hidden" name="fertilizer2_status" id="fertilizer2_status" value="C">
        <input type="hidden" name="harvest_status" id="harvest_status" value="C">
              ...
              <thead>
                <tr>
                 ...
                 <th scope="col" class="text-center" >รหัสแปลงเพาะปลูก</th>
                  ...
                  <th scope="col" class="text-center" >ชื่อข้าว</th>
...
{   //console.log(id);
    // alert(id);
  if ( confirm('คุณต้องการลบที่นาใช่หรือไม่ ?') )
...
{   //console.log(id);
    // alert(id);
  if ( confirm('คุณต้องการยกเลิกที่นาใช่หรือไม่ ?') )
