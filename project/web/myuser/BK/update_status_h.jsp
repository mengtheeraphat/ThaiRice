...
<div class="form-group row">
  ...
  <!--------------------------------     <div class="row gx-3 gy-2 align-items-center">        ----------------------------------------->
       ...
       <div class="form-group row">
        <label for="colFormLabel" class="col-sm-4 col-lg-2 col-form-label">วันที่เก็บเกี่ยว</label>
        <div class="col-sm-4">
 ...
 <div class="form-group row">
        <label for="colFormLabel" class="col-sm-4 col-lg-2 col-form-label">ผลผลิต&nbsp; (กิโลกรัม/ไร่)</label>
        <div class="col-sm-4">
