...
<input type="hidden" name="rice_varieties_id" value="<%=rs.getString("rice_varieties_id") %>">
 ...
 <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">    
        <textarea  rows="5" cols="100" class="form-control" id="rice_varieties_properties" name="rice_varieties_properties"  value=" "><%=rs.getString("rice_varieties_properties") %></textarea>
...
<div class="form-group row">
  ...
  <div class="col-auto">
     ...
     <a href="manage_search01.jsp?q=<%=rs.getString("rice_varieties_id") %>"><button type="button" class="btn btn-outline-dark">ย้อนกลับ</button></a> 
    </div>
  </center>
  <br>
