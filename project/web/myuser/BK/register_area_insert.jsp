...
//                String rice_varieties_id = request.getParameter("rice_varieties_id");
		...
		String sql = "INSERT INTO rice_fieldss (rice_fields_name,rice_field_size,rice_field_soil_type,province,fertilizer1_status,fertilizer2_status,harvest_status,mem_id) VALUES "
                        + "('" + rice_fields_name + "','" + rice_field_size + "','" + rice_field_soil_type + "','" + province + "','" + fertilizer1_status + "','" + fertilizer2_status + "','" + harvest_status + "',"+session.getAttribute("mem_id")+") ";
                s.execute(sql);
