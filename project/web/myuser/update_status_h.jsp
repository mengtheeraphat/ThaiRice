...
<!-- ---------------------------ค้นหาพันธุ์ข้าว--------------------------------- -->
<form id='save_area' name='save_area' action='update_status_h_process.jsp' method="get">
<center>
<div class="container">
  <div>
    <h2 id="scrollspyHeading1">บันทึกเวลาการเก็บเกี่ยว</h2>
  </div>
</div>
</center>
<br>
...
<div class="row" style="margin-left: 10% ;">
  ...
  <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-lg-4">ชื่อแปลงเพาะปลูก</label>
    <div class="col-sm-4">        
...
<div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-lg-4">ขนาดแปลงเพาะปลูก (ไร่)</label>
    <div class="col-sm-4">
      <a ><%=rs.getString("rice_field_size") %> </a>
       ...
       <div class="form-group row">
        <label for="colFormLabel" class="col-sm-2 col-lg-4">วันที่เก็บเกี่ยว</label>
        <div class="col-sm-4">
              <input type="date" id="harvest_status_real" name="harvest_status_real">
        </div>
      </div>  

 <div class="form-group row">
        <label for="colFormLabel" class="col-sm-2 col-lg-4">ผลผลิตที่เก็บเกี่ยวได้&nbsp;(กิโลกรัม)</label>
        <div class="col-sm-4">
              <input type="number" id="quantity_product" name="quantity_product">
        </div>
      </div>  

        <input type="hidden" name="harvest_status" id="harvest_status" value="Y">
      <!--------------------------------      </div>        ----------------------------------------->
</div>
</div>
