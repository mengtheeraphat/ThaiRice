	...
	if(request.getParameter("Action") != null)	
	{
		...
		try {
			...
			if(!rec.next())
			{
				...
				rec.first();
				session.setAttribute("sUserID",rec.getString("adm_name"));	
				response.sendRedirect("http://localhost:8084/project/manage_user.jsp");
			}
				...
				<div class="col-md-7 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Sign In</h3>
		      		...
		      		<div class="form-group">
		      			<input type="text" name="adm_name" id="adm_name" class="form-control rounded-left" placeholder="Username" required>
		      		</div>
