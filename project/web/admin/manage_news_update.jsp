...
<%
    ...
    Class.forName("com.mysql.jdbc.Driver");        
       ...
       // Connection con =  DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/thairice?characterEncoding=UTF-8","root","Meng254398");
        ...
        ResultSet rs = stmt.executeQuery("SELECT * FROM news where news_id = "+request.getParameter("q")); 
...
<div class="container">
  <div>
    <h2 id="scrollspyHeading1">แก้ไขข้อมูลประชาสัมพันธ์</h2>
    <br>
  </div>
</div>
</center>
...
<form method="get" action="manage_news_update_process.jsp">
...
<input type="hidden" name="news_id" value="<%=rs.getString("news_id") %>">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="news_topic" name="news_topic" value="<%=rs.getString("news_topic") %>">
      </div>
    </div>
  ...
  <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="news_source" name="news_source" value="<%=rs.getString("news_source") %>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="date" class="form-control" id="news_date" name="news_date" value="<%=rs.getString("news_date") %>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="news_url" name="news_url" value="<%=rs.getString("news_url") %>">
      </div>
    </div>
  ...
  <div class="col-auto">
    ...
    &nbsp;
    &nbsp;
     <a href="manage_news.jsp?q=<%=rs.getString("news_id") %>"><button type="button" class="btn btn-outline-dark">ปิด</button></a> 
    </div>
  </center>
  <br>
