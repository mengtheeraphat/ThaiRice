...
<center>
    ...
    <div class="form-group row">
     ...
     <div class="form-group row">
      ...
      <div class="col-sm-4">
         <textarea class="form-control" id="warning" name="warning" rows="3" placeholder="ข้อมูลโรค, ศัตรูพืช" required></textarea>
 ...
 <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="number" class="form-control" id="rice_fertilizer1" name="rice_fertilizer1" required >
        </div>
    </div>
     ...
     <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="number" class="form-control" id="rice_fertilizer2" name="rice_fertilizer2" required >
        </div>
    </div>
     ...
     <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="number" class="form-control" id="rice_havest" name="rice_havest" required >
        </div>
    </div>
...
%>  
    <tr>
      <td><div align="center"><%=rs.getString("rice_varieties_id") %></div></td>
        ...
        <td align="center" >
          <a href="admin_showdata.jsp?q=<%=rs.getString("rice_varieties_id") %>"><button type="button" class="btn btn-primary">แสดงข้อมูล</button></a>
          <a href="manage_rice_update.jsp?q=<%=rs.getString("rice_varieties_id") %>"><button type="button" class="btn btn-primary">แก้ไข</button></a>
           <a  ><button id="delete_rice" type="button" class="btn btn-primary" onclick='check_solution(<%=rs.getString("rice_varieties_id") %>); return false;'>ลบ</button></a>
       <!-- <a href="manage_rice_delete.jsp?q=<%=rs.getString("rice_varieties_id") %>"><button type="button" class="btn btn-primary">ลบ</button></a> -->
     </td>
...
{   //console.log(id);
  ...
  { 
    // console.log(id);
       document.getElementById("main").action  = "manage_rice_delete.jsp?q="+id;
