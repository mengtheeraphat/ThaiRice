...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
   ...
   <title> แก้ไขจัดการทะเบียนผู้ใช้ </title>
    <!-- bootstrap.min css -->
...
<%
    ...
    Class.forName("com.mysql.jdbc.Driver");        
        ...
        ResultSet rs = stmt.executeQuery("SELECT * FROM admin where adm_id = "+request.getParameter("q")); 
...
<body>
    ...
    <ul class="nav nav-pills">
      <li class="nav-item">
        <a class="nav-link" href="manage_user01.html">จัดการทะเบียนผู้ใช้</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="manage_rice01.html">จัดการพันธุ์ข้าว</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="manage_price01.html">กำหนดราคาข้าว</a>
      </li>
...
<div class="container">
  <div>
    <h2 id="scrollspyHeading1">แก้ไขจัดการทะเบียนผู้ใช้</h2>
    <br>
  </div>
</div>
</center>
...
<input type="hidden" name="adm_id" value="<%=rs.getString("adm_id") %>">
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="adm_name" name="adm_name" value="<%=rs.getString("adm_name") %>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="adm_login_name" name="adm_login_name" value="<%=rs.getString("adm_login_name") %>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="password" class="form-control" id="adm_passwd" name="adm_passwd" value="<%=rs.getString("adm_passwd") %>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="tel" class="form-control" id="adm_phone" name="adm_phone"  value="<%=rs.getString("adm_phone") %>">
      </div>
    </div>
 ...
 <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="date" class="form-control" id="adm_use_start" name="adm_use_start"  value="<%=rs.getString("adm_use_start") %>">
      </div>
    </div>
  ...
  <div class="col-auto">
    ...
    &nbsp;
    &nbsp;
     <a href="manage_user.jsp?q=<%=rs.getString("adm_id") %>"><button type="button" class="btn btn-outline-dark">ปิด</button></a>  
    </div>
  </center>
