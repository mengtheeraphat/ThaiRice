...
String sql="Update rice_varieties set rice_varieties_name=?,rice_type=?,rice_varieties_properties=?,rice_varieties_quantity=?,rice_varieties_soil_type=?,rice_fertilizer1=?,rice_fertilizer2=?,rice_havest=?,warning=?  where rice_varieties_id="+id;
...
ps.setString(6, rice_fertilizer1);
ps.setString(7, rice_fertilizer2);
ps.setString(8, rice_havest);
ps.setString(9, warning);
