...
<div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="mem_name" id="mem_name" placeholder="">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <textarea class="form-control" name="mem_address" id="mem_address" rows="3" placeholder=""></textarea>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="mem_phone" id="mem_phone" placeholder="">
    </div>
  </div>
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="mem_birthday" id="mem_birthday" placeholder="">
    </div>
  </div>
<!--    <div class="col-sm-1">
...
<!--<div class="form-group row">
  ...
  <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label">ภูมิภาค</label>
    <div class="col-sm-4">
      <select class="form-select mt-2" name="region" >
        <option value="ภูมิภาค" selected>ภูมิภาค</option>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="mem_login_name" id="mem_login_name" placeholder="">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="mem_password" id="mem_password" placeholder="">
    </div>
</div>
