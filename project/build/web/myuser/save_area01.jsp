...
<div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-lg-3">ลักษณะดินที่เหมาะสม</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="rice_varieties_properties" name="rice_varieties_properties" >
      </div>
</div>
    
<div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-lg-3">วัน/เดือน/ปี</label>
    <div class="col-sm-4">
...
//                var upperbound_price = document.getElementById('upperbound_price').value ;
                ...
                // alert(str);
                 ...
                 document.getElementById('rice_varieties_properties').value = n_str[0];
