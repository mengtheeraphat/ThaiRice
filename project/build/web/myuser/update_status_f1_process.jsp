...
String fertilizer1_date_real = request.getParameter("fertilizer1_date_real");
...
String sql="Update rice_fieldss set fertilizer1_status=?,fertilizer1_date_real=?  where rice_fields_id="+id;
ps = con.prepareStatement(sql);
ps.setString(1, fertilizer1_status);
ps.setString(2, fertilizer1_date_real);
