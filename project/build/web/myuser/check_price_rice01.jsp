...
<!--      <li class="nav-item">
    ...
    %>
          ...
          <li class="nav-item">
        <a class="nav-link" href="http:////logout_user_process.jsp">ลงชื่อออก</a>
                ...
                <tr>
                  ...
                  <th scope="col">ชื่อพันธุ์ข้าว</th>  
                   <th scope="col">ประเภทข้าว</th>
                    <th scope="col">ราคาพันธุ์ข้าวขยาย (บาท/กิโลกรัม)</th>
                   <th scope="col">ราคาพันธุ์ข้าวจำหน่าย (บาท/กิโลกรัม)</th>
                   <th scope="col">ราคาข้าวเปลือกต่ำสุด  (บาท/ตัน)</th>  
                  <th scope="col">ราคาข้าวเปลือกสูงสุด (บาท/ตัน)</th>    
...
<% while( rec.next() ) { 
                        ...
                        String last_update = rec.getString("last_update");
