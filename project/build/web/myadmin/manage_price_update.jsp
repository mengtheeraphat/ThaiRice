...
<input type="hidden" name="rice_varieties_id" value="<%=rs.getString("rice_varieties_id") %>">
    ...
    <div class="form-group row">
      <label for="colFormLabel" class="col-sm-2 col-form-label">ราคาข้าวสาร (บาท/เกวียน)</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="rice_varieties_price" name="rice_varieties_price" value="<%=rs.getString("rice_varieties_price") %>">
      </div>
    </div>
  
    <div class="form-group row">
      <label for="colFormLabel" class="col-sm-2 col-form-label">ราคาข้าวเปลือก (บาท/เกวียน)</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="unmilled_rice_price" name="unmilled_rice_price" value="<%=rs.getString("unmilled_rice_price") %>">
      </div>
    </div>
