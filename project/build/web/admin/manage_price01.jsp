...
<div class="container" style="margin-left: 30% ;">
    ...
    <div class="mb-3 row">
      ...
      <label for="staticEmail" class="col-sm-3 col-form-label">ชื่อพันธุ์ข้าว</label>
      <div class="col-sm-4">
...
c.close();
    ...
    <div class="container">
    <div class="mb-3 row">
      <label for="staticEmail" class="col-sm-3 col-form-label">ราคาพันธุ์ข้าวขยาย(บาท/กิโลกรัม)</label>
      <div class="col-sm-4">
        <input type="number" class="form-control" id="registered_seed" name="registered_seed"  >
      </div>
    </div>
    </div>
      ...
      <div class="container">
    <div class="mb-3 row">
      <label for="staticEmail" class="col-sm-3 col-form-label">ราคาพันธุ์ข้าวจำหน่าย(บาท/กิโลกรัม)</label>
      <div class="col-sm-4">
        <input type="number" class="form-control" id="certified_seed" name="certified_seed" >
      </div>
    </div>
    </div>
    ...
    <div class="container">
      <div class="mb-3 row">
        <label for="staticEmail" class="col-sm-3 col-form-label">ราคาข้าวเปลือกต่ำสุด(บาท/ตัน)</label>
        <div class="col-sm-4">
          <input type="number" class="form-control" id="lowerbound_price" name="lowerbound_price" >
        </div>
      </div>
     ...
     <div class="container">
      <div class="mb-3 row">
        <label for="staticEmail" class="col-sm-3 col-form-label">ราคาข้าวเปลือกสูงสุด(บาท/ตัน)</label>
        <div class="col-sm-4">
          <input type="number" class="form-control" id="upperbound_price" name="upperbound_price" >
        </div>
      </div>
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th scope="col">ราคาพันธุ์ข้าวขยาย <br>(บาท/กิโลกรัม)</th>
                   <th scope="col">ราคาพันธุ์ข้าวจำหน่าย<br>(บาท/กิโลกรัม)</th>
                   <th scope="col">ราคาข้าวเปลือกต่ำสุด<br>(บาท/ตัน)</th>  
                  <th scope="col">ราคาข้าวเปลือกสูงสุด<br>(บาท/ตัน)</th> 
...
%>  
    <tr>
        ...
        <td><div align="center"><%=rs.getString("upperbound_price") %></div></td>
          <td><div align="center"><%=rs.getString("last_update") %></div></td>
