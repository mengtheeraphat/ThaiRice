...
<input type="hidden" name="rice_varieties_id" value="<%=rs.getString("rice_varieties_id") %>">
    ...
    <div class="form-group row">
      <label for="colFormLabel" class="col-sm-2 col-form-label">ราคาพันธุ์ข้าวขยาย (บาท/กิโลกรัม)</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="registered_seed" name="registered_seed" value="<%=rs.getString("registered_seed") %>">
      </div>
    </div>
  
    <div class="form-group row">
      <label for="colFormLabel" class="col-sm-2 col-form-label">ราคาพันธุ์ข้าวจำหน่าย (บาท/กิโลกรัม)</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="certified_seed" name="certified_seed" value="<%=rs.getString("certified_seed") %>">
      </div>
    </div>
      
   <div class="form-group row">
      <label for="colFormLabel" class="col-sm-2 col-form-label">ราคาข้าวเปลือกต่ำสุด  (บาท/ตัน)</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="lowerbound_price" name="lowerbound_price" value="<%=rs.getString("lowerbound_price") %>">
      </div>
    </div>

<div class="form-group row">
      <label for="colFormLabel" class="col-sm-2 col-form-label">ราคาข้าวเปลือกสูงสุด (บาท/ตัน)</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="upperbound_price" name="upperbound_price" value="<%=rs.getString("upperbound_price") %>">
      </div>
    </div>
