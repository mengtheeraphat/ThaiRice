...
<input type="hidden" name="rice_varieties_id" value="<%=rs.getString("rice_varieties_id") %>">
    ...
    <div class="form-group row">
      <label for="colFormLabel" class="col-sm-3 col-form-label">คุณสมบัติของพันธุ์ข้าว (บาท/เกวียน)</label>
      <div class="col-sm-3">    
        <textarea  class="form-control" id="rice_varieties_properties" name="rice_varieties_properties"  rows="5" value="<%=rs.getString("rice_varieties_properties") %> "></textarea>
      </div>
    </div>
